    ...
    >
      <div className="relative overflow-hidden aspect-video">
        <img
          ...
          onError={(e) => {
            (e.target as HTMLImageElement).src = 'https://via.placeholder.com/400x300?text=' + lesson.title;
          }}
        />
        ...
        {lesson.teacher && (
          <div className="flex items-center space-x-3 pt-4 border-t border-gray-100">
            <img
              ...
              onError={(e) => {
                (e.target as HTMLImageElement).src = 'https://via.placeholder.com/32?text=' + lesson.teacher.name.charAt(0);
              }}
            />
